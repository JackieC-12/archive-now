...
def seed_archives():
    ...
    marnieArchive = Archive(
        userId=2, url='https://forums.warframe.com/', title='Warframe website', description='Warframe forums website', fileLink='http://archive-now-bucket-pdf.s3.amazonaws.com/53e8649d9062492b860c4416177c5c1f.pdf')
